# This reposiotry contains source code of EOS Software Lyfecycle Manager and developement environment based on EOSIO Web IDE. 
Below you can find instructions to run the setup. 
